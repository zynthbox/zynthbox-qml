    ...
    Timer {
        ...
        onTriggered: {
            ...
            if (root.screenIds.includes(zynqtgui.current_screen_id)) {
                applicationWindow().pageStack.getPage("sketchpad").bottomStack.tracksBar.switchToSlot("sketch-fx", root.selectedChannel.selectedSlot.value);
            }
        }
    }
    Connections {
            ...
            ZUI.SelectorView {
                ...
                onItemActivated: {
                    if (root.selectedChannel.selectedSlot.value === index) {
                        pageManager.getPage("sketchpad").bottomStack.tracksBar.activateSlot("sketchfx", index);
                    } else {
                        pageManager.getPage("sketchpad").bottomStack.tracksBar.switchToSlot("sketchfx", index);
                    }
                ...
                onIconClicked: {
                    ...
                    zynqtgui.current_screen_id = "sketch_effects_for_channel";
                }
                Component.onCompleted: {
