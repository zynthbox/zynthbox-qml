...
class zynthian_gui_keybinding(QObject):
	...
	default_config = {
		...
		"map": {
			...
			"LAYER_1": { "modifier": 0, "keysym": "1" },
			"LAYER_2": { "modifier": 0, "keysym": "2" },
			"LAYER_3": { "modifier": 0, "keysym": "3" },
			"LAYER_4": { "modifier": 0, "keysym": "4" },
			"LAYER_5": { "modifier": 0, "keysym": "5" },
			"LAYER_6": { "modifier": 0, "keysym": "6" },

			"LAYER_11": { "modifier": 4, "keysym": "1" },
			"LAYER_12": { "modifier": 4, "keysym": "2" },
			"LAYER_13": { "modifier": 4, "keysym": "3" },
			"LAYER_14": { "modifier": 4, "keysym": "4" },
			"LAYER_15": { "modifier": 4, "keysym": "5" },
