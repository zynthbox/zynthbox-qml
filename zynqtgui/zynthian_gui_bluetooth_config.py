...
class zynthian_gui_bluetooth_config(zynthian_qt_gui_base.ZynGui):
    ...
    def connectBluetoothPorts(self):
        ...
        def attempt_connection():
            ...
            logging.info(f"Attempting to start zita-j2a bridge, attempt number {self.connection_attempt_count}")
        ...
        def post_startup_task():
            ...
            if self.zita_j2a_process is not None and self.zita_j2a_process.poll() is None:
                ...
                if (self.connection_attempt_count < 5):
                    self.connection_attempt_count = self.connection_attempt_count + 1
                    attempt_connection()
