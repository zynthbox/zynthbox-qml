...
GridLayout {
    ...
    Zynthbox.WaveFormItem {
        ...
        property real pixelsPerBeat: waveBar.controlObj && waveBar.controlObj.hasOwnProperty("time") ? (60/Zynthbox.SyncTimer.bpm*waveBar.controlObj.metadata.speedRatio) / wav.pixelToSecs : 1
