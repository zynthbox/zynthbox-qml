...
Item {
    ...
    Zynthbox.WaveFormItem {
        ...
        Rectangle {
            ...
            width: 1
            x: progressDots.cppClipObject
                ? ZUI2.CommonUtils.fitInWindow(startLoopLine.startPositionRelative + (progressDots.cppClipObject.selectedSliceObject.lengthSamples / progressDots.cppClipObject.durationSamples), waveformItem.relativeStart, waveformItem.relativeEnd) * parent.width
                : 0
        }
