    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            QQC2.Button {
                ...
                onClicked: multitrackRecorderPopup.recordSong(zynthian.zynthiloops.song)
            }
        }
        QQC2.Popup {
            ...
            ColumnLayout {
               implicitHeight: Kirigami.Units.gridUnit * 40
                ...
                Kirigami.Heading {
                    ...
                    Connections {
                        target: multitrackRecorderPopup
                        onOpenedChanged: {
                            if (!multitrackRecorderPopup.opened) {
                                ...
                                for (var trackIndex = 0; trackIndex < 10; ++trackIndex) {
                                    ...
                                    ZL.AudioLevels.setTrackToRecord(trackDelegate.trackIndex, false);
                                }
                            }
                        }
                    }
