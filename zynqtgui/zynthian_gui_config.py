...
if wiring_layout == "Z2_V4" or wiring_layout == "Z1_V1":
    custom_switch_ui_actions = {
        ...
        13: {'S': "ALT_BUTTON", 'B': '', 'L': ''},
        # 14: {'S': "SWITCH_RECORD_RELEASED", 'B': '', 'L': ''},
        # 15: {'S': "SWITCH_PLAY_RELEASED", 'B': '', 'L': ''},
        # 16: {'S': "SWITCH_METRONOME_RELEASED", 'B': '', 'L': ''},
        # 17: {'S': "SWITCH_STOP_RELEASED", 'B': '', 'L': ''},
        # 18: {'S': "SWITCH_BACK_RELEASED", 'B': '', 'L': ''},
        # 19: {'S': "SWITCH_ARROW_UP_RELEASED", 'B': '', 'L': ''},
        # 20: {'S': "SWITCH_SELECT_RELEASED", 'B': '', 'L': ''},
        # 21: {'S': "SWITCH_ARROW_LEFT_RELEASED", 'B': '', 'L': ''},
        # 22: {'S': "SWITCH_ARROW_DOWN_RELEASED", 'B': '', 'L': ''},
        # 23: {'S': "SWITCH_ARROW_RIGHT_RELEASED", 'B': '', 'L': ''},
        # 24: {'S': "SWITCH_GLOBAL_RELEASED", 'B': '', 'L': ''},
        # 25: {'S': "SWITCH_SELECT_RELEASED", 'B': '', 'L': ''}, # Knob3 push - handled in the core cuia handler
        26: {'S': "CP_RV1", 'B': '', 'L': ''},
        27: {'S': "CP_RV2", 'B': '', 'L': ''},
        28: {'S': "CP_RV3", 'B': '', 'L': ''},
        29: {'S': "CP_RV4", 'B': '', 'L': ''}
    ...
    custom_switch_ui_actions = {
        ...
        # 12: {'S': "SCREEN_ADMIN", 'B': '', 'L': ''},
        8: {'S': "ALT_BUTTON", 'B': '', 'L': ''},
        # 9: {'S': "SWITCH_RECORD_RELEASED", 'B': '', 'L': ''},
        # 10: {'S': "SWITCH_PLAY_RELEASED", 'B': '', 'L': ''},
        # 12: {'S': "SWITCH_METRONOME_RELEASED", 'B': '', 'L': ''},
        # 11: {'S': "SWITCH_STOP_RELEASED", 'B': '', 'L': ''},
        # 21: {'S': "SWITCH_BACK_RELEASED", 'B': '', 'L': ''},
        # 22: {'S': "SWITCH_ARROW_UP_RELEASED", 'B': '', 'L': ''},
        # 23: {'S': "SWITCH_SELECT_RELEASED", 'B': '', 'L': ''},
        # 18: {'S': "SWITCH_ARROW_LEFT_RELEASED", 'B': '', 'L': ''},
        # 17: {'S': "SWITCH_ARROW_DOWN_RELEASED", 'B': '', 'L': ''},
        # 16: {'S': "SWITCH_ARROW_RIGHT_RELEASED", 'B': '', 'L': ''},
        # 24: {'S': "SWITCH_GLOBAL_RELEASED", 'B': '', 'L': ''},
        # 29: {'S': "SWITCH_SELECT_RELEASED", 'B': '', 'L': ''}, # Knob3 push - handled in the core cuia handler
        26: {'S': "CP_RV1", 'B': '', 'L': ''},
        25: {'S': "CP_RV2", 'B': '', 'L': ''},
        27: {'S': "CP_RV3", 'B': '', 'L': ''},
        28: {'S': "CP_RV4", 'B': '', 'L': ''}
