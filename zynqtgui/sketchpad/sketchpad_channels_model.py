...
class sketchpad_channels_model(QAbstractListModel):
    IdRole = Qt.UserRole + 1
    NameRole = Qt.UserRole + 2
    ChannelRole = Qt.UserRole + 3

    def __init__(self, parent: QObject):
        super(sketchpad_channels_model, self).__init__(parent)
        self.__song__ = parent
        self.__channels__: [sketchpad_channel] = []
    ...
    def add_channel(self, channel: sketchpad_channel):
