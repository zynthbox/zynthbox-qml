...
class zynthian_gui_song_manager(zynthian_qt_gui_base.zynqtgui):
    ...
    def configure_big_knob(self):
        try:
            if self.__zselector[0] is None:
                self.__zselector_ctrl[0] = zynthian_controller(None, 'song_manager_bigknob', 'song_manager_bigknob', {'midi_cc': 0, 'value': 0})
            ...
            self.__zselector_ctrl[0].set_options({'symbol': 'song_manager_bigknob', 'name': 'Song Manager Big Knob', 'short_name': 'Bigknob', 'midi_cc': 0, 'value_max': 100, 'value_min': 0, 'value': 50})
    ...
    def configure_small_knob_1(self):
        ...
        self.__zselector_ctrl[1].set_options({'symbol': 'song_manager_knob1', 'name': 'Song Manager Knob 1', 'short_name': 'Knob1', 'midi_cc': 0, 'value_max': 100, 'value_min': 0, 'value': 50})
    ...
    def configure_small_knob_2(self):
        ...
        self.__zselector_ctrl[2].set_options({'symbol': 'song_manager_knob2', 'name': 'Song Manager Knob 2', 'short_name': 'Knob2', 'midi_cc': 0, 'value_max': 100, 'value_min': 0, 'value': 50})
    ...
    def configure_small_knob_3(self):
        ...
        self.__zselector_ctrl[3].set_options({'symbol': 'song_manager_knob3', 'name': 'Song Manager Knob 3', 'short_name': 'Knob3', 'midi_cc': 0, 'value_max': 100, 'value_min': 0, 'value': 50})
