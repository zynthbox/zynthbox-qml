...
class zynthian_gui_led_config(zynthian_qt_gui_base.zynqtgui):
    ...
    def update_button_colors_actual(self):
        ...
        library_page_active = self.zynqtgui.current_screen_id in ["layers_for_channel", "bank", "preset", "fixed_effects", "effect_preset", "sketch_effect_preset", "sample_library", "effects_for_channel", "sketch_effects_for_channel"]
