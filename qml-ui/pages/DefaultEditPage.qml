...
RowLayout {
    ...
    property var cuiaCallback: function(cuia) {
        ...
        case "KNOB2_DOWN":
            ...
            return true;
        case "KNOB3_UP":
            zynqtgui.control.selectedColumn = ZUI2.CommonUtils.clamp(zynqtgui.control.selectedColumn + 1, 0, zynqtgui.control.totalColumns - 1)
            return true;
        case "KNOB3_DOWN":
            zynqtgui.control.selectedColumn = ZUI2.CommonUtils.clamp(zynqtgui.control.selectedColumn - 1, 0, zynqtgui.control.totalColumns - 1)
            return true;
                ...
                delegate: QQC2.Control {
                    ...
                    background: Item {
                        ...
                        PlasmaCore.FrameSvgItem {
                            ...
                            property bool highlighted: zynqtgui.control.selectedPage === index
            ...
            RowLayout {
                ...
                Repeater {
                    ...
                    delegate: QQC2.Control {
                        ...
                        padding: svgBg2.visible ? svgBg2.leftPadding : 4
                        ...
                        background: Item {
                            ...
                            PlasmaCore.FrameSvgItem {
                                ...
                                visible: fromCurrentTheme
                                anchors.fill: parent
                                property bool highlighted : isCurrentColumn
