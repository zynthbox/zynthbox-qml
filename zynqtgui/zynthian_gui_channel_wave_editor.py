...
class zynthian_gui_channel_wave_editor(zynthian_qt_gui_base.ZynGui):
    ...
    def configure_big_knob(self):
        try:
            if self.__zselector[0] is None:
                self.__zselector_ctrl[0] = zynthian_controller(None, 'channel_wave_editor_bigknob', 'channel_wave_editor_bigknob', {'midi_cc': 0, 'value': 0})
            ...
            self.__zselector_ctrl[0].set_options({'symbol': 'channel_wave_editor_bigknob', 'name': 'Channel Wave Editor Big Knob', 'short_name': 'Bigknob', 'midi_cc': 0, 'value_max': 100, 'value_min': 0, 'value': 50})
    ...
    def configure_small_knob_1(self):
        if self.__zselector[1] is None:
            self.__zselector_ctrl[1] = zynthian_controller(None, 'channel_wave_editor_knob1', 'channel_wave_editor_knob1', {'midi_cc': 0, 'value': 0})
        ...
        self.__zselector_ctrl[1].set_options({'symbol': 'channel_wave_editor_knob1', 'name': 'Channel Wave Editor Knob 1', 'short_name': 'Knob1', 'midi_cc': 0, 'value_max': 100, 'value_min': 0, 'value': 50})
    ...
    def configure_small_knob_2(self):
        if self.__zselector[2] is None:
            self.__zselector_ctrl[2] = zynthian_controller(None, 'channel_wave_editor_knob2', 'channel_wave_editor_knob2', {'midi_cc': 0, 'value': 0})
        ...
        self.__zselector_ctrl[2].set_options({'symbol': 'channel_wave_editor_knob2', 'name': 'Channel Wave Editor Knob 2', 'short_name': 'Knob2', 'midi_cc': 0, 'value_max': 100, 'value_min': 0, 'value': 50})
    ...
    def configure_small_knob_3(self):
        if self.__zselector[3] is None:
            self.__zselector_ctrl[3] = zynthian_controller(None, 'channel_wave_editor_knob3', 'channel_wave_editor_knob3', {'midi_cc': 0, 'value': 0})
        ...
        self.__zselector_ctrl[3].set_options({'symbol': 'channel_wave_editor_knob3', 'name': 'Channel Wave Editor Knob 3', 'short_name': 'Knob3', 'midi_cc': 0, 'value_max': 100, 'value_min': 0, 'value': 50})
