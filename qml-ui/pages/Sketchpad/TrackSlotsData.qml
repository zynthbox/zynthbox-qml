        ...
        delegate: Item {
            ...
            Component{
                ...
                ZUI.SlotControl  {
                    ...
                    enabled: (control.slotType !== "external") || (control.slotType === "external" && (realIndex === 0 || (realIndex === 1 && isEmpty === false) || (realIndex === 2 && zynqtgui.ui_settings.showExperimentalFeatures)))
                    visible: enabled
